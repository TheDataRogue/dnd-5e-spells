...
def class_spells(char_class:str):
    ...
    first_level = first_level.sort_values('name').reset_index().drop('index',axis=1)
    second_level = char_class_spells[char_class_spells['level'] == 2]
    second_level = second_level.sort_values('name').reset_index().drop('index',axis=1)
    third_level = char_class_spells[char_class_spells['level'] == 3]
    third_level = third_level.sort_values('name').reset_index().drop('index',axis=1)
    fourth_level = char_class_spells[char_class_spells['level'] == 4]
    fourth_level = fourth_level.sort_values('name').reset_index().drop('index',axis=1)
    fifth_level = char_class_spells[char_class_spells['level'] == 5]
    fifth_level = fifth_level.sort_values('name').reset_index().drop('index',axis=1)
    sixth_level = char_class_spells[char_class_spells['level'] == 6]
    sixth_level = sixth_level.sort_values('name').reset_index().drop('index',axis=1)
    seventh_level = char_class_spells[char_class_spells['level'] == 7]
    seventh_level = seventh_level.sort_values('name').reset_index().drop('index',axis=1)
    eighth_level = char_class_spells[char_class_spells['level'] == 8]
    eighth_level = eighth_level.sort_values('name').reset_index().drop('index',axis=1)
    ninth_level = char_class_spells[char_class_spells['level'] == 9]
    ninth_level = ninth_level.sort_values('name').reset_index().drop('index',axis=1)
